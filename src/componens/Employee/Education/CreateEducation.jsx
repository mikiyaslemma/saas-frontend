...
import { createEducation, listEducationLevels, listFieldStudies, REST_API_BASE_URL } from "../../../../Services/apiData";
...
const CreateEducation = ({ id }) => {
  ...
  const handleFormSubmit = async (values) => {
    try {
      ...
      const response = await createEducation(employerId, formData);
  ...
  return (
    <Box m="20px">
      ...
      <SearchComponent 
       label="Enter Id to Get all Employee Educations"
       path="/employee/EducationAction"
       ids={ids}
       actionLabel="All Educations" 
