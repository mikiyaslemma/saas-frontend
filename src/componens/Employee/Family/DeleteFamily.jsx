...
import { deleteFamilyOfEmployee } from "../../../../Services/apiData";
...
const DeleteFamily = () => {
  ...
  const familyId = location?.state?.id; // Ensure this is a string or number

  // Debugging log
  console.log("Employee ID:", employerId, "Family ID:", familyId);
  ...
  const handleDelete = async () => {
    try {
      await deleteFamilyOfEmployee(employerId, familyId);
