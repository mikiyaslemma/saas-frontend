...
import { editApplicantLanguages, getApplicantLanguagesbyId, getLanguageById, REST_API_BASE_URL, updateLanguage } from "../../../../../../Services/apiData";
...
const EditApplicantLanguage = () => {
  ...
  const handleFormSubmit = async (values) => {
    try {
      const response = await editApplicantLanguages(applicantId, languageId, values);
  ...
  const fetchLanguage = async () => {
    try {
      const response = await getApplicantLanguagesbyId(applicantId,languageId);
  ...
  const fetchAllLanguages = async () => {
    try {
      const response = await axios.get(`${REST_API_BASE_URL}language-names/1/get-all`);
