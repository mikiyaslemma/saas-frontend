...
import { editApplicantCertificate, getApplicatantCertificatefileById } from "../../../../../../Services/apiData";
import { getApplicantCertificateById ,REST_API_BASE_URL} from "../../../../../../Services/apiData";
const EditApplicantCertificate = () => {
  ...
  console.log(`the trainingId is ${trainingId} and the applicantId is ${applicantId} `);
  ...
  const fetchFileOfTraining = async () => {
    try {
      const fileBlob = await getApplicatantCertificatefileById(applicantId,trainingId);
  ...
  const fetchTraining = async () => {
    try {
      const response = await getApplicantCertificateById(applicantId, trainingId);
  ...
  const handleFormSubmit = async (values) => {
    try {
      ...
      const response = await editApplicantCertificate(applicantId, trainingId, formData); // Correct way to call the API function
