...
import {  createAnnualTrainingPlan, getAnnualTrainingPlanById, listCourseCategory, listCourseTrainingByCategory, listOfBudgetYears, listTrainingInstution, REST_API_BASE_URL, updateAnnualTrainingPlan } from "../../../../Services/apiData";
...
const UpdateAnnualTrainingPlan = () => {
    ...
    console.log(annualTrainingPlanId);
    ...
    useEffect(() => {
      ...
      const fetchAnnualTrainingPlanById = async () => {
        try {
          const response = await getAnnualTrainingPlanById(annualTrainingPlanId);
    ...
    const handleFormSubmit = async (values, { resetForm }) => {
        try {
            ...
            await updateAnnualTrainingPlan(annualTrainingPlanId,values);
    ...
    const validationSchema = yup.object().shape({
        departmentId: yup.number()
            ...
            .nullable(),  // Ensure null is allowed in case of missing value
    
        budgetYearId: yup.number()
            .required("Budget year ID is required")
            .nullable(),
        ...
        venue: yup.string()
            .required("Venue cannot be blank"),
    
        remark: yup.string().nullable(), // Making remark nullable to handle the optional field
    
        courseCategoryId: yup.number()
            .required("Course category ID is required")
            .nullable(),
    
        trainingCourseId: yup.number()
            .required("Training course ID is required")
            .nullable(),
    
        trainingInstitutionId: yup.number()
            .required("Training institution ID is required")
            .nullable(),
    });
