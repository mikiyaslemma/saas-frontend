...
import { addAnnualTrainingRequest, listCourseCategory, listCourseTrainingByCategory, listOfBudgetYears, listTrainingInstution, REST_API_BASE_URL } from "../../../../Services/apiData";
...
const CreateAnnualTrainingRequest = () => {
    ...
    const handleFormSubmit = async (values, { resetForm }) => {
        try {
            await addAnnualTrainingRequest(values);
