import {
  ...
  import { createEducationOpportunity, getAllQualification, getEducationOpportunityById, getEmployeeByEmployeId, listEducationLevels, listOfBudgetYears, REST_API_BASE_URL, updateeducationOpportunity } from "../../../../Services/apiData";
  ...
  const UpdateEductionOpportunity = () => {
    ...
    console.log(educationOpportunityId);
    ...
    const fetchEducationOpportunity = async () => {
        try {
          const response = await getEducationOpportunityById(educationOpportunityId);
    ...
    const handleFormSubmit = async (values, { resetForm }) => {
      try {
        await updateeducationOpportunity(educationOpportunityId,values);
