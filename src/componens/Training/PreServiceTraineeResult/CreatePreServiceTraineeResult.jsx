...
import { addRecruitment, createPreServiceTraineeResult, listCourseType, listPreServiceTraining } from "../../../../Services/apiData";
...
const CreatePreServiceTraineeResult = () => {
  ...
  const handleFormSubmit = async (values) => {
    try {
      ...
      await createPreServiceTraineeResult(traineeId,courseId ,values);
