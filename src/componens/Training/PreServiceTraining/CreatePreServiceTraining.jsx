...
import { addPreServiceTraining, getDocuments, listEducationLevels, listFieldStudies, listOfBudgetYears } from "../../../../Services/apiData";
...
const CreatePreServiceTraining = () => {
  ...
  const handleFormSubmit = async (values) => {
    try {
      ...
      const response = await addPreServiceTraining(formData);
